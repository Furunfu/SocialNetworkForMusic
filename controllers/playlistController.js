...
exports.createPlaylist = async (req, res) => {
    try {
        ...
        if (!title) {
            return res.status(400).json({ message: "Provide a title for your playlist, please" });
        }
        ...
        const result = await client.db("pwm").collection("playlists").insertOne(newPlaylist);
...
exports.deletePlaylist = async (req, res) => {
    try {
        ...
        const collection = client.db("pwm").collection("playlists");
